        ...
        <main className="flex flex-col items-center justify-center py-20">
          ...
          <div className="mt-16 flex flex-col items-center space-y-12">
            <div className="text-center">
              <h2
                className="mt-10 text-4xl text-transparent bg-clip-text 
                        bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500"
              >
                Within Our Club!
              </h2>
              <p className="mt-4 text-lg max-w-2xl">
                Discover a world of fascinating activities and thrilling
                experiences at our club. Whether you are looking to learn
                something new, meet amazing people, or simply have fun, we have
                something for everyone. Come and be part of our dynamic
                community!
              </p>
            </div>
